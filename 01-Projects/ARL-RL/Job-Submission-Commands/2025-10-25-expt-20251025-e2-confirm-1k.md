---
title: "Job for expt-20251025-e2-confirm-1k"
date: "2025-10-25"
last_updated: "2025-11-30T13:10:00Z"
tags: ["project/arl-rl", "job"]
experiment: "[[../../Documents/Experiments/expt-20251025-e2-confirm-1k]]"
scheduler: "slurm"
cluster: "Gilbreth HPC"
resources: { nodes: 1, gpus: 1, cpus: 4, mem_gb: 50, time: "04:00:00", partition: "a30" }
env_setup:
  modules: []
...
---
## Commands
- Exact submission command(s) (inferred):
  ```bash
  ...
  ```
## Notes
Run on standby partition (inferred from typical confirmation workflow).
## Changelog
